...
if ($atts['layout'] == 'boxed') {
	...
	$output .= '<div class="cont row-wrap-boxed">';
	...
	$output .= '<div class="page-cont">';

} elseif ($atts['layout'] == 'full') {
	$output .= '<div class="container-fluid page-styling row-wrap-full">';

	if (!empty($atts['row_title'])) {
		$output .= '<h2 class="row-wrap-ttl">'.$atts['row_title'].'</h2>';
	}
} else {
	...
	if (!empty($atts['row_title'])) {
		...
		$output .= '<div class="container page-styling row-wrap-container row-wrap-nottl">';
	}
}
