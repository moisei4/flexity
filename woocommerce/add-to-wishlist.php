...
<div class="yith-wcwl-add-to-wishlist add-to-wishlist-<?php echo esc_attr($product_id); ?> prod-li-favorites">
	<?php if( ! ( $disable_wishlist && ! is_user_logged_in() ) ): ?>
	    ...
	    <div class="yith-wcwl-wishlistaddedbrowse hide" style="display:none;">
	    	...
	    	<a class="active" href="<?php echo esc_url( $wishlist_url )?>" rel="nofollow"></a>
	    </div>
